...
export function Step0Welcome({ onNext }: Props) {
  return (
    <div className="flex flex-col min-h-[100dvh] bg-white w-full relative overflow-hidden">
      ...
      <div className="relative w-full h-[40dvh] min-h-[260px] max-h-[420px] flex-shrink-0 z-10">
        <Image
      ...
      {/* Content Canvas */}
      <div className="relative -mt-16 px-5 sm:px-8 flex flex-col z-20 pb-8 flex-1">
        {/* Branding Accent */}
        ...
        {/* Headline */}
        <h1 className="text-[1.875rem] sm:text-4xl font-extrabold text-[#1A1C1C] leading-[1.1] tracking-[-0.9px] mb-3">
          The easiest calorie tracker for Sri Lankan food.
        </h1>

        {/* Subheadline */}
        <p className="text-base sm:text-[1.125rem] text-[#3C4A46] leading-relaxed mb-5 w-[95%]">
          Personalized insights for Kottu, Hoppers, and your daily Rice & Curry.
        </p>

        {/* Bento-lite Feature Highlights */}
        <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-5 sm:mb-6">
          <div className="bg-[#F3F3F3] rounded-[20px] sm:rounded-[24px] p-4 sm:p-5 flex flex-col gap-2 sm:gap-3 h-[90px] sm:h-[100px] justify-center relative shadow-sm overflow-hidden border border-white/50">
          ...
          <div className="bg-[#FFDDB8]/30 rounded-[20px] sm:rounded-[24px] p-4 sm:p-5 flex flex-col gap-2 sm:gap-3 h-[90px] sm:h-[100px] justify-center relative shadow-sm overflow-hidden border border-white/50">
