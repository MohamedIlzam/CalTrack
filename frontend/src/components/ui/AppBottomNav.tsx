export function AppBottomNav() {
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[80px] bg-white/90 backdrop-blur-xl border-t border-gray-100 shadow-[0_-4px_24px_rgba(0,0,0,0.04)] z-50 flex justify-between items-center px-4 pb-safe">
      ...
      {/* Today (Active) */}
      <button className="flex flex-col items-center justify-center w-[60px] h-[52px] bg-[#F0FDFA] rounded-2xl text-[#0F766E]">
      ...
      {/* Search */}
      <button className="flex flex-col items-center justify-center w-[60px] h-[52px] text-gray-400">
        <svg className="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
